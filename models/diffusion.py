...
class DiffusionPoint(Module):
    ...
    # N step backward from current point cloud (Used for purification/denoising)
    def truncated_sample(self, pointcloud, T, flexibility=0.0, ret_traj=False, context=None):
